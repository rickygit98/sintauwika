...
<body class="hold-transition sidebar-mini layout-fixed">
    <div class="wrapper">
        ...
        <div class="preloader flex-column justify-content-center align-items-center">
            <img class="animation__shake" src="/img/brand.png" alt="brand" height="60" width="60">
        </div>
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="index3.html" class="brand-link">
                <img src="/img/brand.png" alt="brand" class="brand-image img-circle elevation-3" style="opacity: .8">
            ...
            <div class="sidebar">
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                        ...
                        <li class="nav-item">
                            <a href="/dosen/topik/" class="nav-link {{ Request::is('dosen/topik') ? 'active' : '' }}">
                        ...
                        <li class="nav-item">
                            <a href="/dosen/skripsi/"
                                class="nav-link {{ Request::is('dosen/skripsi') ? 'active' : '' }}">
