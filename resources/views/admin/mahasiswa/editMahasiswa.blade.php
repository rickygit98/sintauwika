    <!-- Modal -->
    <div wire:ignore.self class="modal fade" id="editMhs" tabindex="-1" aria-labelledby="editMhsLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="editMhsLabel">Edit Data Mahasiswa</h5>
                    ...
                    <form>
                        ...
                        <div class="input-group mb-3">
                            <input id="name" type="text" class="form-control @error('name') is-invalid @enderror"
                                ...
                                autocomplete="name" autofocus wire:model.lazy='name'>
                        ...
                        <div class="input-group mb-3">
                            <input id="username" type="text"
                                ...
                                autofocus wire:model.lazy='username'>
                        ...
                        <div class="input-group mb-3" id="an">
                            ...
                            <input id="nrp" type="text" class="form-control" name="nrp" value="{{ old('nrp') }}"
                                placeholder="Enter NRP" maxlength="8" wire:model.lazy='nrp'>
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-primary" wire:click.prevent='updateMahasiswa()'>Update</button>
                </div>
            </div>
        </div>
    </div>
