    <!-- Modal -->
    <div wire:ignore.self class="modal fade" id="addMhs" tabindex="-1" aria-labelledby="addMhsLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="addMhsLabel">Create New Mahasiswa</h5>
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-primary" wire:click.prevent='storeMahasiswa()'>Add</button>
                </div>
            </div>
        </div>
    </div>
