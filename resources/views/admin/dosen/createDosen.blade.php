    <!-- Modal -->
    <div wire:ignore.self class="modal fade" id="addDsn" tabindex="-1" aria-labelledby="addDsnLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="addDsnLabel">Create New Dosen</h5>
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-primary" wire:click.prevent='storeDosen()'>Add</button>
                </div>
            </div>
        </div>
    </div>
